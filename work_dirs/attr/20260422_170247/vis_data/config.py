...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ann_file='annotations/train_with_attributes.json',
...
test_evaluator = dict(
    ann_file=
    '/mnt/d/Testing VSCode/pest_small-DS/data/pest/annotations/train_with_attributes.json',
    metric='bbox',
    proposal_nums=(
        100,
        1,
...
val_ann_file = 'annotations/train_with_attributes.json'
