...
test_dataloader = dict(
    ...
    dataset=dict(
        class_text_path=
        '/mnt/d/Testing VSCode/pest_small-DS/data/texts/class_texts_species_only.json',
        dataset=dict(
            ann_file='annotations/train_instances_hierarchical.json',
...
test_evaluator = dict(
    ann_file=
    '/mnt/d/Testing VSCode/pest_small-DS/data/pest/annotations/train_instances_hierarchical.json',
    metric='bbox',
    proposal_nums=(
        100,
        1,
...
train_ann_file = 'annotations/train_instances_hierarchical.json'
...
val_ann_file = 'annotations/train_instances_hierarchical.json'
